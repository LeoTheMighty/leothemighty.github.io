...
const captions: { [s: number]: JSX.Element } = {
  ...
  28: <p> Note: DO NOT DO THIS, this was a very very fast moving river and got a little desperate trying to cross it, and we actually managed to get halfway across this river and THEN found out that there was no way we could cross it all the way. Then we realized that the water has getting higher because it was getting later in the morning and we <b>seriously thought</b> that we weren't able to cross back and be STUCK... but then we managed to hop over the way we came. I was terrified at this point because Sydney got MAD MAD close to falling in at one point and I legitimately thought I was going to have a heart attack because earlier we were pushing boulders, trying to create more of a path, and we kicked a Pele-sized rock into there that literally got swept up as if it were a leaf so i thought oh god if she falls in it's like OVER over. But then we got back. and then walked along the river for half a mile. and then found a giant log stretched perfectly across the river. and then simply crossed it like a bridge........ so yeah. that's my closest with death story ;p </p>,
